        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-20 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-600">
                    ...
                    <div class="mt-8 text-2xl dark:text-gray-100">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg sm:px-20">
                <div class="mt-8 text-2xl dark:text-gray-100">
                ...
                <table class="table-fixed min-w-full">
                    ...
                    <tbody>
                        @forelse($log as $l)
                        @if ($l->loglevel == 'error')<tr class="bg-red-100 dark:bg-red-900">@else <tr>@endif
                            <td class="border dark:border-gray-600 px-4 py-2">{{ $l->board }}</td>
                            <td class="border dark:border-gray-600 px-4 py-2">{{ $l->cm }}</td>
                            <td class="border dark:border-gray-600 px-4 py-2">{!! nl2br(e($l->created_at->toTimeString().' '.$l->msg), false) !!}</td>
                        </tr>
                        @empty
