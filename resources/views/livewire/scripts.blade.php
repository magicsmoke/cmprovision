        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <table class="table-fixed min-w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="border dark:border-gray-600 px-4 py-2">{{ $s->name }}</td>
                        <td class="border dark:border-gray-600 px-4 py-2">{{ $s->script_type }}</td>
                        <td class="border dark:border-gray-600 px-4 py-2">{{ $s->priority }}</td>
