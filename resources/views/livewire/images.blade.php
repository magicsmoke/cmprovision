...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            @endif
            @if ($errors->any())
            <div class="bg-orange-100 dark:bg-orange-900 border-l-4 border-orange-500 text-orange-700 dark:text-orange-200 p-4" role="alert">
                <p>
                <ul>
            ...
            <table class="table-fixed min-w-full">
                ...
                <tbody>
                    @forelse($images as $i)
                    <tr>
                        <td class="border dark:border-gray-600 px-4 py-2"><span style="word-break: break-all;">{{ $i->filename }}</span> (added {{ date_format($i->created_at, "d-M-Y") }})</td>
                    ...
                    @empty
                    <tr><td class="border dark:border-gray-600 px-4 py-2" colspan="4">No entries</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
