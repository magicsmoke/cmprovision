  ...
  <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
    ...
    <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
      <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div class="">
              <div class="mb-4">
                  <label for="name" class="block text-gray-700 dark:text-gray-200 text-sm font-bold mb-2">Project name:</label>
              ...
              <div class="mb-4">
                  <label for="image_id" class="block text-gray-700 dark:text-gray-200 text-sm font-bold mb-2">Image to write:</label>
                  <select id="image_id" name="image_id" wire:model.defer="image_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 leading-tight focus:outline-none focus:shadow-outline">
              ...
              <div class="mb-4">
                  <label for="storage" class="block text-gray-700 dark:text-gray-200 text-sm font-bold mb-2">Destination storage device:</label>
                  <input type="text" id="storage" name="storage" wire:model.defer="storage" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 leading-tight focus:outline-none focus:shadow-outline">
                  @error('storage') <span class="text-red-500">{{ $message }}</span>@enderror
              </div>
              <div class="mb-4">
                  <label for="firmware" class="block text-gray-700 dark:text-gray-200 text-sm font-bold mb-2">EEPROM firmware update to apply:</label>
                  <select id="firmware" name="firmware" wire:model="firmware" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 leading-tight focus:outline-none focus:shadow-outline">
                    <option value="">-none-</option>
                  ...
                  <div class="flex">
                    <div>
                      ...
                      <div class="mt-3 flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto">
                        <button wire:click="resetEEPROMsettings" class="border border-gray-300 dark:border-gray-600 px-4 py-2 bg-white dark:bg-gray-700 text-base leading-6 font-medium text-gray-700 dark:text-gray-200 shadow-sm hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue transition ease-in-out duration-150 sm:text-sm sm:leading-5">
              ...
              @endif
              <div class="mb-4">
                  <label for="eeprom_settings" class="block text-gray-700 dark:text-gray-200 text-sm font-bold mb-2">EEPROM settings:</label>
                  <textarea type="text" id="eeprom_settings" name="eeprom_settings" wire:model.defer="eeprom_settings" class="h-28 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 leading-tight focus:outline-none focus:shadow-outline"></textarea>
                  @error('eeprom_settings') <span class="text-red-500">{{ $message }}</span>@enderror
              </div>
              @endif
              <div class="mb-4">
                  <label for="label_moment" class="block text-gray-700 dark:text-gray-200 text-sm font-bold mb-2">When to print label:</label>
                  <select id="label_moment" name="label_moment" wire:model="label_moment" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 leading-tight focus:outline-none focus:shadow-outline">
              ...
              <div class="mb-4">
                  <label for="label_id" class="block text-gray-700 dark:text-gray-200 text-sm font-bold mb-2">Label to print:</label>
                  <select id="label_id" name="label_id" wire:model.defer="label_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 leading-tight focus:outline-none focus:shadow-outline">
