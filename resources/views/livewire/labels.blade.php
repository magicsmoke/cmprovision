        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <table class="table-fixed min-w-full">
                ...
                <tbody>
                    @forelse($labels as $l)
                    <tr>
                        <td class="border dark:border-gray-600 px-4 py-2">{{ $l->name }}</td>
                        <td class="border dark:border-gray-600 px-4 py-2">{{ $l->printer_type }}</td>
                        <td class="border dark:border-gray-600 px-4 py-2">@if ($l->printer_type == "ftp"){{ $l->ftp_hostname }}@else N/A @endif</td>
